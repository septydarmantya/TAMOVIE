...
public class SoonFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) getView().findViewById(R.id.soonrecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        SoonmAdapter = new SoonAdapter(this.getActivity(), mList);
        recyclerView.setAdapter(SoonmAdapter);

        downloadDataSources();
    }

    private void downloadDataSources() {
        String url = "https://api.themoviedb.org/3/movie/upcoming?api_key=0c0d5f9e08e0ec928a762ec0710e3bf1";
        ...
        GsonGetRequest<ResultsResponse> myRequest = new GsonGetRequest<ResultsResponse>
                (url, ResultsResponse.class, null, new Response.Listener<ResultsResponse>() {
                    ...
                    public void onResponse(ResultsResponse response) {
                        ...
                        SoonmAdapter.notifyDataSetChanged();
                    }
